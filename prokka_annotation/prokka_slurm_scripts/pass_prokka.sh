...
cd /share/BioinfMSc/rotation1/Group3/merged_long/fastq_pass/pass_assembly

#Running prokka on merged pass assembly
prokka --outdir /share/BioinfMSc/rotation1/Group3/prokka_annotation/pass_annotation1 assembly.fasta
