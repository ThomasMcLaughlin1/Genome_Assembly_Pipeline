...
cd /share/BioinfMSc/rotation1/Group3/merged_long/fastq_fail/fail_assembly

#Running prokka on the merged all assembly
prokka --outdir /share/BioinfMSc/rotation1/Group3/prokka_annotation/fail_annotation1 assembly.fasta
