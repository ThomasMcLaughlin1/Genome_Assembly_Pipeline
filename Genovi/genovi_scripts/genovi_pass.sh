...
cd /share/BioinfMSc/rotation1/Group3/prokka_annotation 

genovi -i /share/BioinfMSc/rotation1/Group3/prokka_annotation/pass_annotation1/PROKKA_02062025.gbk -s complete
